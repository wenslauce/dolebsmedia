...
export const metadata = {
  title: "Energy Industry News & Updates | Dolebs Media",
  description: "Stay informed about the latest developments in sustainable energy, industry trends, and Dolebs Media's project updates.",
};
...
const newsArticles: NewsArticle[] = [
  {
    id: 1,
    title: "Dolebs Media Completes Largest Commercial Solar Installation in Region",
