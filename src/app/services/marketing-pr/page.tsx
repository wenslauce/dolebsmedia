...
import { Megaphone, Users, Award, CheckCircle, Building, Globe, Star, ArrowRight, Target } from "lucide-react";
    ...
    <main className="min-h-screen">
      ...
      <div className="pt-0 pb-16">
        ...
        <div className="relative h-[650px]">
          <Image
            src="/images/marketing-pr.avif"
            alt="Marketing & PR Services"
            fill
            ...
            <div className="container mx-auto px-4">
              ...
              >
                ...
                >
                  ...
                  <span className="text-sm font-medium text-white">Marketing & PR</span>
                </motion.span>
                ...
                >
                  Comprehensive Marketing & PR to Boost Your Visibility
                </motion.h1>
                ...
                >
                  Our integrated marketing and public relations approach helps you reach the right audience and build lasting brand recognition. We combine strategic thinking with creative execution to deliver results that matter.
                </motion.p>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                <div className="bg-white/90 backdrop-blur-md p-6 rounded-xl shadow-xl border border-gray-100">
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600">Campaigns Launched</p>
                    </div>
                  </div>
                </div>
                ...
                <div className="bg-white/90 backdrop-blur-md p-6 rounded-xl shadow-xl border border-gray-100">
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600">Brands Elevated</p>
                    </div>
                  </div>
                </div>
                ...
                <div className="bg-white/90 backdrop-blur-md p-6 rounded-xl shadow-xl border border-gray-100">
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      <h3 className="text-2xl font-bold text-secondary">2M+</h3>
                      <p className="text-gray-600">Reach Generated</p>
                    </div>
                  </div>
                </div>
              </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            >
              <h2 className="text-3xl md:text-4xl font-semibold text-secondary mb-6">
                Building Brand Recognition Through Strategic Marketing & PR
              </h2>
              <p className="text-gray-700 text-lg mb-8">
                Our comprehensive marketing and public relations services help you build brand awareness, engage your target audience, and establish thought leadership in your industry. We combine data-driven strategies with creative execution to deliver measurable results.
              </p>
              ...
              <div className="space-y-5 mb-8">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">We develop comprehensive marketing and PR strategies aligned with your business objectives and target audience.</p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">We leverage multiple marketing channels and PR tactics to maximize your reach and impact.</p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <h3 className="text-lg font-medium text-secondary">Measurable Results</h3>
                    <p className="text-gray-600">We provide detailed analytics and reporting to track campaign performance and ROI.</p>
                  </div>
                </div>
              </div>
              ...
              <div className="relative w-full h-[500px] rounded-2xl overflow-hidden shadow-2xl">
                ...
                <div className="absolute bottom-8 left-8 right-8">
                  <div className="bg-white/90 backdrop-blur-sm p-6 rounded-xl border border-white/20">
                    ...
                    <p className="text-gray-700">Our marketing and PR services combine strategic thinking with creative execution to build brand recognition and drive meaningful engagement.</p>
                  </div>
                </div>
              </div>
          ...
          <div className="container mx-auto px-4">
            ...
            >
              ...
              <p className="text-gray-700 max-w-3xl mx-auto">
                We offer comprehensive marketing and public relations services designed to boost your visibility and build lasting brand recognition
              </p>
            </motion.div>
                ...
                <div className="absolute bottom-0 left-0 right-0 p-8 text-white">
                  <div className="flex flex-col space-y-4">
                    <div className="flex items-center gap-3 mb-2">
                      ...
                      <h3 className="text-2xl font-semibold">Public Relations</h3>
                    </div>
        ...
        <div className="bg-white py-20" id="get-quote">
          <div className="container mx-auto px-4">
            <div className="max-w-3xl mx-auto bg-gray-50 rounded-2xl shadow-lg p-8 md:p-12">
              <ServiceQuoteForm serviceType="marketing-pr" serviceName="Marketing & PR" />
            </div>
          </div>
        </div>
              ...
              <div className="relative p-8 md:p-12">
                <div className="max-w-3xl mx-auto text-center">
                  ...
                  <p className="text-white/90 mb-8 text-lg">
                    Let's discuss your marketing and PR needs and create strategic solutions that build brand recognition and drive engagement.
                  </p>
