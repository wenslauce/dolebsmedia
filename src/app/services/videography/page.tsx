...
import { Video, Users, Award, CheckCircle, Building, Home, Star, ArrowRight, Play } from "lucide-react";
            ...
            <div className="container mx-auto px-4">
              ...
              >
                ...
                >
                  ...
                  <span className="text-sm font-medium text-white">Professional Videography</span>
                </motion.span>
                ...
                >
                  Compelling Video Content That Engages and Drives Results
                </motion.h1>
                ...
                >
                  Our videography services bring your brand to life through dynamic storytelling and professional production. From corporate videos to promotional content, we create compelling visual narratives that engage your audience and drive meaningful results.
                </motion.p>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            >
              <h2 className="text-3xl md:text-4xl font-semibold text-secondary mb-6">
                Dynamic Storytelling Through Professional Videography
              </h2>
              <p className="text-gray-700 text-lg mb-8">
                Our videography services combine technical expertise with creative vision to produce compelling video content that engages audiences and drives results. We specialize in creating dynamic visual narratives that bring your brand story to life.
              </p>
              ...
              <div className="space-y-5 mb-8">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">We use state-of-the-art cameras, lighting, and audio equipment to ensure the highest quality production values.</p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <h3 className="text-lg font-medium text-secondary">Creative Direction</h3>
                    <p className="text-gray-600">Our team brings years of experience in visual storytelling and creative direction to every project.</p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <h3 className="text-lg font-medium text-secondary">End-to-End Production</h3>
                    <p className="text-gray-600">From concept development to final delivery, we handle every aspect of video production with attention to detail.</p>
                  </div>
                </div>
              </div>
              ...
              <div className="relative w-full h-[500px] rounded-2xl overflow-hidden shadow-2xl">
                ...
                <div className="absolute bottom-8 left-8 right-8">
                  <div className="bg-white/90 backdrop-blur-sm p-6 rounded-xl border border-white/20">
                    ...
                    <p className="text-gray-700">Our videography services combine technical expertise with creative vision to deliver compelling video content that engages your audience and drives meaningful results.</p>
                  </div>
                </div>
              </div>
          ...
          <div className="container mx-auto px-4">
            ...
            >
              ...
              <p className="text-gray-700 max-w-3xl mx-auto">
                We offer comprehensive videography services tailored to meet your specific needs and marketing objectives
              </p>
            </motion.div>
                ...
                <div className="absolute bottom-0 left-0 right-0 p-8 text-white">
                  <div className="flex flex-col space-y-4">
                    <div className="flex items-center gap-3 mb-2">
                      ...
                      <h3 className="text-2xl font-semibold">Corporate Videos</h3>
                    </div>
                    ...
                    <div className="bg-white/10 backdrop-blur-md rounded-xl p-5 border border-white/10">
                      <ul className="space-y-3 text-white/90">
                        <li className="flex items-start gap-3">
                          ...
                          <span>Company overview and brand videos</span>
                        </li>
                        <li className="flex items-start gap-3">
                          <div className="w-5 h-5 rounded-full bg-primary/20 flex-shrink-0 flex items-center justify-center mt-1">
                            <div className="w-2 h-2 rounded-full bg-primary"></div>
                          </div>
                          <span>Training and educational content</span>
                        </li>
                        <li className="flex items-start gap-3">
                          <div className="w-5 h-5 rounded-full bg-primary/20 flex-shrink-0 flex items-center justify-center mt-1">
                            <div className="w-2 h-2 rounded-full bg-primary"></div>
                          </div>
                          <span>Internal communications and announcements</span>
                        </li>
                      </ul>
                    </div>
                  </div>
                ...
                <div className="absolute bottom-0 left-0 right-0 p-8 text-white">
                  <div className="flex flex-col space-y-4">
                    <div className="flex items-center gap-3 mb-2">
                      ...
                      <h3 className="text-2xl font-semibold">Promotional Videos</h3>
                    </div>
                    ...
                    <div className="bg-white/10 backdrop-blur-md rounded-xl p-5 border border-white/10">
                      <ul className="space-y-3 text-white/90">
                        <li className="flex items-start gap-3">
                          ...
                          <span>Product launch and marketing videos</span>
                        </li>
                        <li className="flex items-start gap-3">
                          <div className="w-5 h-5 rounded-full bg-red-600/20 flex-shrink-0 flex items-center justify-center mt-1">
                            <div className="w-2 h-2 rounded-full bg-red-600"></div>
                          </div>
                          <span>Social media content and ads</span>
                        </li>
                        <li className="flex items-start gap-3">
                          <div className="w-5 h-5 rounded-full bg-red-600/20 flex-shrink-0 flex items-center justify-center mt-1">
                            <div className="w-2 h-2 rounded-full bg-red-600"></div>
        ...
        <div className="bg-white py-20" id="get-quote">
          <div className="container mx-auto px-4">
            <div className="max-w-3xl mx-auto bg-gray-50 rounded-2xl shadow-lg p-8 md:p-12">
              <ServiceQuoteForm serviceType="videography" serviceName="Videography" />
            </div>
          </div>
        </div>
              ...
              <div className="relative p-8 md:p-12">
                <div className="max-w-3xl mx-auto text-center">
                  ...
                  <p className="text-white/90 mb-8 text-lg">
                    Let's discuss your video production needs and create engaging content that brings your brand story to life.
                  </p>
