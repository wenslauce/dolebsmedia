    ...
    <main className="min-h-screen">
      ...
      <div className="pt-0 pb-16">
        ...
        <div className="relative h-[650px]">
          <Image
            src="/images/graphic-design.avif"
          ...
          <div className="absolute inset-0 bg-gradient-to-r from-secondary/90 to-secondary/70 flex items-center">
            <div className="container mx-auto px-4">
              ...
              >
                ...
                >
                  From logos to marketing materials, we create designs that capture attention and communicate your message effectively. Our graphic design services combine creativity with strategic thinking to deliver visual solutions that elevate your brand.
                </motion.p>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            >
              <h2 className="text-3xl md:text-4xl font-semibold text-secondary mb-6">
                Visual Excellence Through Creative Design
              </h2>
              <p className="text-gray-700 text-lg mb-8">
                Our graphic design services combine artistic creativity with strategic thinking to create visual solutions that capture attention and communicate your message effectively. We specialize in creating designs that make your brand stand out from the crowd.
              </p>
              ...
              <div className="space-y-5 mb-8">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <h3 className="text-lg font-medium text-secondary">Creative Excellence</h3>
                    <p className="text-gray-600">We approach every project with fresh creativity and innovative design solutions that capture your brand's essence.</p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <h3 className="text-lg font-medium text-secondary">Brand Consistency</h3>
                    <p className="text-gray-600">We ensure all designs maintain consistency with your brand identity and messaging across all touchpoints.</p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <h3 className="text-lg font-medium text-secondary">Professional Quality</h3>
                    <p className="text-gray-600">We deliver high-quality designs that meet professional standards and exceed client expectations.</p>
                  </div>
                </div>
              </div>
              ...
              <div className="relative w-full h-[500px] rounded-2xl overflow-hidden shadow-2xl">
                ...
                <div className="absolute bottom-8 left-8 right-8">
                  <div className="bg-white/90 backdrop-blur-sm p-6 rounded-xl border border-white/20">
                    ...
                    <p className="text-gray-700">Our graphic design services combine artistic creativity with strategic thinking to create visual solutions that capture attention and communicate your message effectively.</p>
                  </div>
                </div>
              </div>
          ...
          <div className="container mx-auto px-4">
            ...
            >
              ...
              <p className="text-gray-700 max-w-3xl mx-auto">
                We offer comprehensive graphic design services that help your brand stand out and communicate effectively
              </p>
            </motion.div>
                    ...
                    <div className="bg-white/10 backdrop-blur-md rounded-xl p-5 border border-white/10">
                      <ul className="space-y-3 text-white/90">
                        ...
                        <li className="flex items-start gap-3">
                          ...
                          <span>Brand style guide development</span>
                        </li>
                      </ul>
                    </div>
                  </div>
                ...
                <div className="absolute bottom-0 left-0 right-0 p-8 text-white">
                  <div className="flex flex-col space-y-4">
                    <div className="flex items-center gap-3 mb-2">
                      ...
                      <h3 className="text-2xl font-semibold">Marketing Materials</h3>
                    </div>
                    ...
                    <div className="bg-white/10 backdrop-blur-md rounded-xl p-5 border border-white/10">
                      <ul className="space-y-3 text-white/90">
                        ...
                        <li className="flex items-start gap-3">
                          ...
                          <span>Banner and signage design</span>
                        </li>
                      </ul>
                    </div>
                  </div>
              ...
              <div className="relative p-8 md:p-12">
                <div className="max-w-3xl mx-auto text-center">
                  ...
                  <p className="text-white/90 mb-8 text-lg">
                    Let's discuss your design needs and create visual solutions that capture attention and communicate your message effectively.
                  </p>
