...
import { MessageSquare, Users, Award, CheckCircle, Building, Globe, Star, ArrowRight, Megaphone } from "lucide-react";
      ...
      <div className="pt-0 pb-16">
        ...
        <div className="relative h-[650px]">
          <Image
            ...
            alt="Strategic Communication Solutions"
            fill
            ...
            <div className="container mx-auto px-4">
              ...
              >
                ...
                >
                  ...
                  <span className="text-sm font-medium text-white">Strategic Communications</span>
                </motion.span>
                ...
                >
                  Strategic Communication Solutions That Amplify Your Message
                </motion.h1>
                ...
                >
                  We help you connect with your audience through clear, compelling, and impactful communication strategies. Our expertise in strategic communications ensures your message reaches the right people at the right time with maximum impact.
                </motion.p>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                <div className="bg-white/90 backdrop-blur-md p-6 rounded-xl shadow-xl border border-gray-100">
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      <h3 className="text-2xl font-bold text-secondary">150+</h3>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            >
              ...
              <p className="text-gray-700 text-lg mb-8">
                Our strategic communication solutions help you craft compelling messages that resonate with your target audience. We combine creative storytelling with data-driven insights to ensure your communications achieve maximum impact and engagement.
              </p>
              ...
              <div className="space-y-5 mb-8">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <h3 className="text-lg font-medium text-secondary">Strategic Planning</h3>
                    <p className="text-gray-600">We develop comprehensive communication strategies tailored to your goals and target audience.</p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <h3 className="text-lg font-medium text-secondary">Content Creation</h3>
                    <p className="text-gray-600">Our team creates compelling content that engages your audience and drives meaningful conversations.</p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <h3 className="text-lg font-medium text-secondary">Multi-Channel Approach</h3>
                    <p className="text-gray-600">We leverage multiple communication channels to ensure your message reaches your audience effectively.</p>
                  </div>
                </div>
              </div>
              ...
              <div className="relative w-full h-[500px] rounded-2xl overflow-hidden shadow-2xl">
                ...
                <div className="absolute bottom-8 left-8 right-8">
                  <div className="bg-white/90 backdrop-blur-sm p-6 rounded-xl border border-white/20">
                    <h3 className="text-xl font-medium text-secondary mb-2">Strategic Excellence</h3>
                    <p className="text-gray-700">Our communication solutions combine strategic thinking with creative execution to deliver messages that resonate and drive results.</p>
                  </div>
                </div>
              </div>
          ...
          <div className="container mx-auto px-4">
            ...
            >
              ...
              <p className="text-gray-700 max-w-3xl mx-auto">
                We offer comprehensive communication services designed to amplify your message and connect with your audience
              </p>
            </motion.div>
                ...
                <div className="absolute bottom-0 left-0 right-0 p-8 text-white">
                  <div className="flex flex-col space-y-4">
                    <div className="flex items-center gap-3 mb-2">
                      ...
                      <h3 className="text-2xl font-semibold">Internal Communications</h3>
                    </div>
                    ...
                    <div className="bg-white/10 backdrop-blur-md rounded-xl p-5 border border-white/10">
                      <ul className="space-y-3 text-white/90">
                        <li className="flex items-start gap-3">
                          ...
                          <span>Employee engagement and culture building</span>
                        </li>
                        <li className="flex items-start gap-3">
                          <div className="w-5 h-5 rounded-full bg-primary/20 flex-shrink-0 flex items-center justify-center mt-1">
                            <div className="w-2 h-2 rounded-full bg-primary"></div>
                          </div>
                          <span>Change management communications</span>
                        </li>
                        <li className="flex items-start gap-3">
                          <div className="w-5 h-5 rounded-full bg-primary/20 flex-shrink-0 flex items-center justify-center mt-1">
                            <div className="w-2 h-2 rounded-full bg-primary"></div>
                          </div>
                          <span>Leadership messaging and announcements</span>
                        </li>
                      </ul>
                    </div>
                  </div>
                ...
                <div className="absolute bottom-0 left-0 right-0 p-8 text-white">
                  <div className="flex flex-col space-y-4">
                    <div className="flex items-center gap-3 mb-2">
                      ...
                      <h3 className="text-2xl font-semibold">External Communications</h3>
                    </div>
                    ...
                    <div className="bg-white/10 backdrop-blur-md rounded-xl p-5 border border-white/10">
                      <ul className="space-y-3 text-white/90">
                        ...
                        <li className="flex items-start gap-3">
                          ...
                          <span>Public relations and media relations</span>
                        </li>
                        <li className="flex items-start gap-3">
                          <div className="w-5 h-5 rounded-full bg-red-600/20 flex-shrink-0 flex items-center justify-center mt-1">
                            <div className="w-2 h-2 rounded-full bg-red-600"></div>
        ...
        <div className="bg-white py-20" id="get-quote">
          <div className="container mx-auto px-4">
            <div className="max-w-3xl mx-auto bg-gray-50 rounded-2xl shadow-lg p-8 md:p-12">
              <ServiceQuoteForm serviceType="communications" serviceName="Communications" />
            </div>
          </div>
        </div>
              ...
              <div className="relative p-8 md:p-12">
                <div className="max-w-3xl mx-auto text-center">
                  ...
                  <p className="text-white/90 mb-8 text-lg">
                    Let's discuss your communication needs and create strategic solutions that connect your message with the right audience.
                  </p>
