      ...
      <div className="container-custom py-16">
        ...
        >
          ...
          <div className="relative z-10 max-w-3xl mx-auto text-center">
            ...
            <Link
              href="/consultation"
              className="bg-accent-gold hover:bg-accent-gold/90 text-secondary px-8 py-4 rounded-lg inline-flex items-center font-medium transition-all group shadow-lg hover:shadow-xl"
            >
              Get Quote
